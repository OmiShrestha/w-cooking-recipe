                        ...
                        if (isAdmin) {
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.buttonColors(
                                    containerColor = Color(0xFFC0614A),
                            ...
                            if (showDeleteDialog) {
                                AlertDialog(
                                    ...
                                    text = { Text("Are you sure you want to delete \"${details.recipe.name}\"? This cannot be undone.") },
                                    confirmButton = {
                                        TextButton(onClick = {
                                            viewModel.deleteRecipe(details.recipe) {
